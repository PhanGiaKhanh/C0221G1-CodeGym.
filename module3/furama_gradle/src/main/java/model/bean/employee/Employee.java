...
public class Employee {
    ...
    public Employee(String name, String birthday, String idCard, double salary, String phone, String email, String address, int idPosition, int idDegree, int idDivision, String userName) {
        this.name = name;
