...
select hd.id_hop_dong, nv.ho_ten, kh.ho_ten, kh.sdt, dv.ten_dich_vu, sum(hdct.so_luong), hd.tien_dat_coc, hd.ngay_lam_hop_dong
from khach_hang kh
...
select dvdk.id_dich_vu_di_kem, dvdk.ten_dich_vu_di_kem, dvdk.gia, dvdk.don_vi, hdct.so_luong
from hop_dong_chi_tiet hdct, dich_vu_di_kem dvdk, hop_dong hd
where hdct.id_dich_vu_di_kem = dvdk.id_dich_vu_di_kem
and hdct.id_hop_dong = hd.id_hop_dong
and so_luong >=5
