...
<nav class="navbar navbar-light bg-light border border-info ">
    ...
    <div class="navbar-brand h1 text-info"><h1>Product list</h1></div>
    <div class="navbar-brand mb-0 h1">Phan Gia Khánh</div>
</nav>
<!--#endregion-->
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-3 p-0 text-right">
            ...
            <form action="/products?action=search" method="post" class="d-flex justify-content-end">
        ...
        <tr>
            ...
            <td>
                <c:forEach items="${categories}" var="category">
                    <c:if test="${category.id == product.c_id}">
                        ${category.name}
                    </c:if>
            ...
            <td class="d-flex">
                <a href="/products?action=edit&id=${product.id}" type="button"
                   class="btn btn-warning mx-1 btnDisplay" style="width: 50px">
                    Edit
                </a>
                <!-- Button trigger modal DELETE -->
                <button onclick="myFunction(${product.id})" type="button"
