...
<%--                            <div class="text-danger">${mapMsg.get("name")}</div>--%>
                            <input class="form-control" type="text" value="${student.getId()}" name="id">
                        </td>
                    </tr>
                    <tr>
                        <td>Name</td>
                        <td>
                              <div class="text-danger">${mapMsg.get("name")}</div>
                            <input class="form-control" type="text" value="${student.getName()}" name="name"></td>
                    </tr>
                    <tr>
                        <td>Gender</td>
                        ...
                        <td>
                            <select class="form-control" name="gender" id="">
                                  <option value="Nam" ${student.getGender() == "Nam"? "selected" : ""}>Nam</option>
                                  <option value="Nữ" ${student.getGender()  == "Nữ"? "selected" : ""}>Nữ</option>
                                  <option value="Khác" ${student.getGender()  == "Khác"? "selected" : ""}>Khác</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input class="form-control" type="date" value="${student.getBirthday()}" name="birthday"></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td>
                            <div class="text-danger">${mapMsg.get("email")}</div>
                            <input class="form-control" type="text" value="${student.getEmail()}" name="email"></td>
                    </tr>
                    <tr>
                        <td>Address</td>
                        <td>
                            <div class="text-danger">${mapMsg.get("address")}</div>
                            <input class="form-control" type="text" value="${student.getAddress()}"  name="address"></td>
                    </tr>
                    <tr>
                        <td>Point</td>
                        <td>
                            <div class="text-danger">${mapMsg.get("point")}</div>
                            <input class="form-control" type="number" value="${student.getPoint()}" name="point"></td>
                    </tr>

<%--                    <tr>--%>
<%--                        <td>Type customer ${customer.getType()}</td>--%>
<%--                        <td>--%>
...
<%--&lt;%&ndash;                                    <option value=""> ${customerType.name}  -  ${customerType.id}  -  ${customer.type}</option>&ndash;%&gt;--%>
